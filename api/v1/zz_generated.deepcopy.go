...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZeebeProject) DeepCopyInto(out *ZeebeProject) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZeebeProject.
func (in *ZeebeProject) DeepCopy() *ZeebeProject {
	if in == nil {
		return nil
	}
	out := new(ZeebeProject)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ZeebeProject) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZeebeProjectList) DeepCopyInto(out *ZeebeProjectList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ZeebeProject, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZeebeProjectList.
func (in *ZeebeProjectList) DeepCopy() *ZeebeProjectList {
	if in == nil {
		return nil
	}
	out := new(ZeebeProjectList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ZeebeProjectList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZeebeProjectSpec) DeepCopyInto(out *ZeebeProjectSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZeebeProjectSpec.
func (in *ZeebeProjectSpec) DeepCopy() *ZeebeProjectSpec {
	if in == nil {
		return nil
	}
	out := new(ZeebeProjectSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZeebeProjectStatus) DeepCopyInto(out *ZeebeProjectStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZeebeProjectStatus.
func (in *ZeebeProjectStatus) DeepCopy() *ZeebeProjectStatus {
	if in == nil {
		return nil
	}
	out := new(ZeebeProjectStatus)
	in.DeepCopyInto(out)
	return out
}
